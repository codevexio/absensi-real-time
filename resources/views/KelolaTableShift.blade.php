    ...
    <div class="py-6">
                            ...
                            <tbody class="text-gray-800 dark:text-gray-200">
                                @forelse($shifts as $index => $shift)
                                    <tr class="hover:bg-gray-200 dark:hover:bg-gray-700 text-center"
                                        data-id="{{ $shift->id }}">
                                        <td class="border px-4 py-2 text-center">{{ $shifts->firstItem() + $index }}</td>
        ...
        <dialog id="tambah-shift" class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 w-full max-w-lg">
            ...
            <form id="form-tambah-shift" action="{{ route('shift.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="namaShift" id="tambah-nama-shift"
                ...
                <div class="mb-4">
                    ...
                    <input type="time" name="waktuMulai" id="tambah-waktu-mulai"
                        class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white" required>
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 dark:text-gray-200">Jam Selesai</label>
                    <input type="time" name="waktuSelesai" id="tambah-waktu-selesai"
                        class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white" required>
                </div>
        ...
        <script>
            ...
            btnEdits.forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    document.getElementById("form-edit-shift").action = `{{ url('/kelola-table-shift') }}/${id}`;
        ...
        <script>
            ...
            tombolTambah.addEventListener("click", () => {
                // Reset form jika sebelumnya pernah dibuka
