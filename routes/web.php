...
Route::put('/kelola-akun', [KelolaAkunController::class,'update'])->name('web/kelola-akun-put');
Route::delete('/kelola-akun', [KelolaAkunController::class,'destroy'])->name('web/kelola-akun-del');
